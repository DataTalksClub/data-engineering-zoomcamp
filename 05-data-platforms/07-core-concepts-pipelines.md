...
![A Bruin project contains multiple pipelines, each organized around its own schedule.](images/bruin-project-pipelines.png)

![Pipeline configuration connects a schedule, connections, variables, and assets.](images/bruin-pipeline-configuration.png)
