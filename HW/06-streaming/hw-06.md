...
of the last command?
Отсутствие видимого вывода: Команда producer.bootstrap_connected() это внутренний метод, используемый для установления соединения Kafka с указанным сервером. Если соединение успешно, никакого специального вывода не будет.
