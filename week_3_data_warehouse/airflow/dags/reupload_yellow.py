...
with DAG(
    ...
    while execution_date <= end_date:
        ...
        execution_date_t=execution_date.strftime("%Y-%m")
        url_template = f"{URL_PREFIX}/yellow_tripdata_{execution_date_t}.csv"
        local_csv_path_template= f"{AIRFLOW_HOME}/yellow_tripdata_{execution_date_t}.csv"
        local_parquet_path_template = f"{AIRFLOW_HOME}/yellow_tripdata_{execution_date_t}.parquet"
        gcs_path_template = f"raw/yellow_tripdata/{execution_date_t[:4]}/yellow_tripdata_{execution_date_t}.parquet"
