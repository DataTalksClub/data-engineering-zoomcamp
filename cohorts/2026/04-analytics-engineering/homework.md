...
- `stg_green_tripdata`, `stg_yellow_tripdata`, and `int_trips_unioned` (downstream dependancies)
- Any model with upstream and downstream dependencies to `int_trips_unioned`
- `int_trips_unioned` only
- `int_trips_unioned`, `int_trips`, and `fct_trips` (upstream dependancies)
...
### Question 4. Counting Records in `fct_monthly_zone_revenue`
...
### Question 5. Best Performing Zone for Green Taxis (2020)
...
### Question 6. Green Taxi Trip Counts (October 2019)
...
### Question 7. Build a Staging Model for FHV Data
