...
from settings import BOOTSTRAP_SERVERS, RIDE_SCHEMA, \
...
if __name__ == "__main__":
    spark = SparkSession.builder.appName('homework-06').getOrCreate()
    spark.sparkContext.setLogLevel('WARN')

    # read_streaming data
    df_consume_stream = read_from_kafka(consume_topic=FHV_TAXI_TOPIC)
    ...
    df_trip_count_by_pickup_id = op_groupby(df_rides, ['pu_location_id'])
    df_trip_count_by_pickup_date_pickup_id = op_windowed_groupby(
        df_rides, 
