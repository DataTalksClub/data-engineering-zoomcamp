...
dbt show --select stg_green_tripdata --limit 5
dbt show --select stg_yellow_tripdata --limit 5
```
...
**Solution**: Build the staging models first:
```bash
